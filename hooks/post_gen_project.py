...
scaffolded_into_existing_repo = (project_root / ".git").exists()
if scaffolded_into_existing_repo:
    print("Detected existing .git in target directory; skipping git init/commit.")
else:
    try:
...
print()
if scaffolded_into_existing_repo:
    print("Scaffolded into an existing repo. Files that already existed were")
    print("skipped (assuming you used --skip-if-file-exists). Review the new")
    print("files with `git status` and merge anything you want to keep.")
    print()
    print("See docs/PIPELINE.md for setup, Wynton SGE, and Slurm instructions.")
else:
    print("Next steps:")
